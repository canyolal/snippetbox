...
import (
	...
	"github.com/canyolal/snippetbox/internal/validator"
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	// Declare a new empty instance of snippetCreateForm
	var form snippetCreateForm

	// Call decodePostForm() to decode the form and handle form.Decoder.Decode() error.
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		if errors.Is(err, models.ErrDuplicateEmail) {
			form.AddFieldErrors("email", "Email adress already in use.")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// Check whether the credentials are valid. If ther're not, add a generric
	...
	// state or privilege levels changes for the user(e.g. login and logout ops).
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	// RenewToken() on current session to change the session ID again.
	...
	// Redirect the user to the application home.
